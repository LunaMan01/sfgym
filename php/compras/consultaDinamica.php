<?php
    ...
    try{
        $query = $conn->prepare('SELECT Id_Compra, Compras.Id_Instructor, descripcion_compra, monto_compra, fecha_compra
        FROM Compras INNER JOIN Instructores ON Compras.Id_Instructor LIKE Instructores.Id_Instructor WHERE 
        Id_Compra LIKE ? OR Compras.Id_Instructor LIKE ? OR descripcion_compra LIKE ? OR monto_compra LIKE ? 
